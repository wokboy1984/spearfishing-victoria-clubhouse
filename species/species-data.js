globalThis.SV_SPECIES = {
  snapper: {
    name: 'Snapper',
    scientific: 'Chrysophrys auratus',
    group: 'Fish',
    image: 'sv-snapper.webp',
    imageAlt: 'Snapper on the Victorian coast',
    summary: 'A familiar Victorian reef and bay species, with juvenile fish often called pinkies.',
    size: '28 cm minimum',
    ...
    recipe: {
      title: 'Whole roasted snapper with tomato and herbs',
      time: '45 min',
      serves: 'Serves 4',
      image: 'sv-roasted-snapper.webp',
      description: 'A generous tray bake with lemon, garlic and the fish’s own roasting juices.',
  ...
  'king-george-whiting': {
    ...
    group: 'Fish',
    image: 'species-king-george-whiting.png',
    imageAlt: 'King George whiting over seagrass',
    summary: 'A slender inshore species associated with sand, seagrass and sheltered Victorian coastal waters.',
    size: '27 cm minimum',
    bag: '20',
    note: 'Keep whole or in carcass form while in or on Victorian waters.',
    ...
    recipe: {
      title: 'Herb-crumbed whiting fillets',
      time: '25 min',
      serves: 'Serves 2',
      image: 'species-king-george-whiting.png',
      description: 'A light oven-baked crumb with parsley and lemon zest.',
  ...
  'southern-calamari': {
    ...
    group: 'Cephalopod',
    image: 'species-southern-calamari.png',
    imageAlt: 'Southern calamari above Victorian seagrass',
    summary: 'A colour-changing cephalopod found across Victorian bays and coastal seagrass habitat.',
    size: 'No minimum',
    ...
    recipe: {
      title: 'Charred calamari with lemon and parsley',
      time: '20 min',
      serves: 'Serves 3',
      image: 'species-southern-calamari.png',
      description: 'Fast, hot cooking with garlic, lemon and parsley.',
  ...
  'yellowtail-kingfish': {
    ...
    group: 'Fish',
    image: 'species-yellowtail-kingfish.png',
    ...
    recipe: {
      title: 'Miso-glazed kingfish',
      time: '35 min',
      serves: 'Serves 4',
      image: 'species-yellowtail-kingfish.png',
      description: 'Rich kingfish balanced with miso, ginger and rice vinegar.',
  ...
  'southern-bluefin-tuna': {
    ...
    group: 'Fish',
    image: 'species-southern-bluefin-tuna.png',
    imageAlt: 'Southern bluefin tuna in open ocean',
    summary: 'A powerful open-ocean species found along Victoria’s offshore coast.',
    size: 'No minimum',
    ...
    recipe: {
      title: 'Pepper-crusted tuna with warm tomato salad',
      time: '25 min',
      serves: 'Serves 4',
      image: 'species-southern-bluefin-tuna.png',
      description: 'Quick-seared tuna with capers, lemon and warm tomatoes.',
